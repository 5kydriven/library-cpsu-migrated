...
const router = createRouter({
	...
	routes: [
		...
		},
		{
			...
			name: 'user-account',
			component: () =>
				import('../pages/userPortal/account/userAccountForm.vue'),
		...
		},
		{
			...
			children: [
				...
				},
				{
					path: '/books-list',
					name: 'books-list',
					component: () => import('@/pages/librarian/books/index.vue'),
				},
				{
					path: '/student-logs',
					name: 'student-logs',
				...
				},
				{
					...
					name: 'book-logs',
					component: () =>
						import('@/pages/librarian/transactions/BookLogs.vue'),
				},
			],
		},
		{
...
router.beforeEach(async (to, from, next) => {
	...
	const requiresLibrarian = to.matched.some(
		(record) => record.meta.requiresLibrarian,
	);
