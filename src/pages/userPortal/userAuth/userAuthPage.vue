        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6">
                    ...
                    <Button @click="onSubmit(isLogin? false : true)" :label="isLogin? 'Sign In' : 'Sign Up'" class="w-full font-medium" />
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400" v-else>
                        Already have an account? <a @click.prevent="isLogin = !isLogin" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
